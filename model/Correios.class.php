...
class Correios{
	...
	private $url   = 'http://ws.correios.com.br/calculador/CalcPrecoPrazo.aspx';
        ...
        function __construct($destino,$peso) {
				...
				$this->altura 		= '15';//em cm
				$this->largura     	= '15';//em cm
				$this->diametro 	= '30';//em cm
		...
		**/
        public function Calcular(){
			...
			$cURL = curl_init(sprintf(
				$this->url.'?nCdEmpresa=08082650&sDsSenha=564321&nCdServico=%s,%s&sCepOrigem=%s&sCepDestino=%s&nVlPeso=%s&nCdFormato=%s&nVlComprimento=%s&nVlAltura=%s&nVlLargura=%s&nVlDiametro=%s&sCdMaoPropria=%s&nVlValorDeclarado=%s&sCdAvisoRecebimento=%s&StrRetorno=%s',
				$this->servico,
				$this->servico2,
				$this->cepOrigem,
				$this->cepDestino,
